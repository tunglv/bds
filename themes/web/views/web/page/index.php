                ...
                <div id="om-s2xymi2yl8-lightbox" class="optin-monster-overlay"
                    ...
                    <div id="om-lightbox-case-study-optin"
                        ...
                        <div id="om-lightbox-case-study-optin-wrap" class="om-clearfix"><a
                            ...
                            <div id="om-lightbox-case-study-optin-bar" class="om-clearfix" style="background-color: #008b33;height: 15px;"></div>
                ...
                <div class="list">
                    ...
                    <div style="display: block; margin: 5px 10px; border-bottom: 1px solid #ccc; padding-bottom: 5px;">
                        <a href="<?php echo $pt[0]->url ?>"
                           style="color:  #008b33 !important; font-weight: bold;"><?php echo $pt[0]->title ?></a></div>
                    <ul>
    ...
    <div id="ctl49_BodyContainer" class="bor_box">
        <div class="customer-name" style="display: block;margin: 0 auto;padding-top: 10px;">
            <input id="customer-name" type="text" placeholder="HỌ VÀ TÊN"
                   style="border-radius: 5px;width: 90%;margin: 0 auto;display: block;border: 1px solid  #008b33;padding: 5px;">
        ...
        <div class="customer-name" style="display: block;margin: 0 auto;padding-top: 10px;"><span
                ...
                style="border-radius: 5px;width: 90%;margin: 0 auto;display: block;border: 1px solid  #008b33;padding: 2px;background-color:  #008b33;color: #fff;font-weight: bold;text-align: center;cursor: pointer;">ĐĂNG KÝ</span>
        </div>
    </div>
    <div id="ctl49_FooterContainer">
    </div>
        ...
        <div class="content">
            <div id="suport">
                <div class="widget-content">
                    ...
                    <center><span
                            style="font-weight: bold;color:  #008b33;">0976.078.988 - 0936.404.616 - 0986.616.445</span>
                    </center>
                    ...
                    <center><a href="mailto:levy.hua@gmail.com?subject=Liên hệ mua bán chung cư"
                               style="font-size: 14px;font-weight: bold;margin: 20px;display: block;color:  #008b33">levy.hua@gmail.com</a>
                    </center>
                </div>
            </div>
        </div>
