...
<!--    }-->
<!--</script>-->
<div id="ctl27_ctl01_panelPtDetails" class="contentDetail">

    <h1 id="ctl27_ctl01_divArticleTitle" class="detailsView-title-style"><?php echo $pt->title?></h1>
    <div id="ctl27_ctl01_divDate" class="date-first"><?php echo date("d/m/Y H:i", $pt->created)?></div>
        ...
        <?php if(count($topic)>0):?>
            <div>
                <div class="inasub">
                    ...
                    <a href="<?php echo Yii::app()->createUrl('/web/pt/topic', array('alias'=>$pt->topic->alias,'id' => $pt->topic_id))?>"><?php echo $pt->topic->title?></a></div>
                <div class="subinart">
                    <?php foreach($topic as $_key_topic => $_val_topic):?>
                        <div class="artlist">
                            <a href="<?php echo Yii::app()->createUrl('/web/pt/detail', array('alias'=>$_val_topic['alias'],'id' => $_val_topic['id']))?>" class="line"><?php echo $_val_topic['title']?></a>
                        </div>
                    <?php endforeach;?>
                </div>
            </div>
    ...
    <div class="detailsView-contents-style">
        <h2 id="ctl27_ctl01_divSummary" class="summary"><?php echo $pt->desc?></h2>

    </div>
    <div id="divContents" class="detailsView-contents-style detail-article-content" style="overflow: hidden;"><?php echo $pt->content?></div>
    <div id="ctl27_ctl01_divSourcePt" class="detailsView-contents-style soucept" style="padding: 10px">
    </div>
...
<div id="ctl27_ctl01_panelOtherPt">
    ...
    <div class="otherpt">
        <?php if(count($same) > 0):?>
            ...
            <div class="otherline"></div>
            <?php foreach($same as $_k_pt => $_val_pt):?>
                <a class="font-link-box-item iconlist" href="<?php echo Yii::app()->createUrl('/web/pt/detail', array('alias'=>$_val_pt['alias'],'id' => $_val_pt['id']))?>" title="<?php echo $_val_pt['title']?>"><?php echo $_val_pt['title']?><i>(<?php echo date("d/m", $_val_pt['created'])?>)</i></a>
            <?php endforeach;?>
        <?php endif;?>
    </div>
...
<div style="text-align: right;">
    <a id="lnkNewOther" class="normalblue" href="<?php echo Yii::app()->createUrl('/web/pt/list', array('alias'=>$pt->aliasTypeLabel))?>" style="cursor: pointer;
...
</div><!--//Modules/Pt/ManagerPt/ViewerComments.ascx--></div>
</div>
