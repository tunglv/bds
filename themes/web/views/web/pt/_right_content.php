                ...
                <div style="padding: 5px; width: 60px; height: 60px; float: left;">
                    <div class="many-readers-title-icon">
                        <a title="<?php echo $_val_viewed->title?>"
                           href="<?php echo Yii::app()->createUrl('/web/pt/detail', array('alias'=>$_val_viewed->alias,'id' => $_val_viewed->id))?>">
                ...
                <div class="data-default-CSSClass">
                    <p style="padding: 0px; margin: 5px 5px 0 0;">
                        <a class="controls-view-date-contents-link"
                           href="<?php echo Yii::app()->createUrl('/web/pt/detail', array('alias'=>$_val_viewed->alias,'id' => $_val_viewed->id))?>" title="<?php echo $_val_viewed->title?>">
...
<?php endif?>
<!--//Modules/Pt/ViewerPt/TopMostRead/ManyReaders.ascx-->
<div class="container-common">
        ...
        <div class="list">
            <ul>
                <?php foreach($top_topic as $_key_top_topic => $_val_top_topic):?>
                    <li><a href="<?php echo Yii::app()->createUrl('/web/pt/topic', array('alias'=>$_val_top_topic->alias,'id' => $_val_top_topic->id))?>" title="<?php echo $_val_top_topic->title?>">
                            <?php echo $_val_top_topic->title?></a></li>
                <?php endforeach;?>
            </ul>
        </div>
        <div style="padding-left: 20px; padding-top: 5px; border-top: 1px solid #ccc; margin-top: 10px;">
            <a href="<?php echo Yii::app()->createUrl('/web/pt/listTopic')?>" class="linktoall">Xem tất
                cả</a>
        </div>
    </div>
