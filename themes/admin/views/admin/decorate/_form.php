        ...
        <div id="da-ex-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <div style="padding-bottom: 20px;">
                ...
                <div class="par control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($model,'topic_id', TopicDecorate::model()->getData()); ?>
                ...
                <script>
                    $(function(){
                        $("#a_url").click(function(){
                            ...
                            $("#img_url").show();
                            $('#img_file').hide();
                            $('#Decorate_upload_method').val('url');    
                        });
                        $("#a_file").click(function(){
                            ...
                            $("#img_url").hide();
                            $('#img_file').show();
                            $('#Decorate_upload_method').val('file');    
                        });
                        ...
                        $("#Decorate_image_url").bind('change keyup blur', function(evt){
                            var method = $('#Decorate_upload_method').val();
                ...
                <div class="par control-group">
                    ...
                    <div class="controls">
                        <?php if($this->action->id == 'update'):?>
                            ...
                            <img id="img_url" style="height: 60px; width: auto; margin-left: 220px;" src="<?php echo Decorate::model()->getImageUrl( $model->id , '260');?>"/>
                            <!--<img style="height: 60px; width: auto;margin-left: 220px;" src="<?php // echo Decorate::model()->getImgUrl($model->id, $model->image.'_small.jpg');?>" />-->
                            <?php else:?> 
                            <img id="img_file" style="display: none; height: 60px; width: auto; margin-left: 220px;" /> 
