...
<div class="grid_4">
                ...
                <script>
                    $(function(){
                        $("#a_url").click(function(){
                            ...
                            $("#img_url").show();
                            $('#img_file').hide();
                            $('#TopicDecorate_upload_method').val('url');
                        });
                        $("#a_file").click(function(){
                            ...
                            $("#img_url").hide();
                            $('#img_file').show();
                            $('#TopicDecorate_upload_method').val('file');
                        });
                        ...
                        $("#TopicDecorate_image_url").bind('change keyup blur', function(evt){
                            var method = $('#TopicDecorate_upload_method').val();
                ...
                <div class="par control-group">
                    ...
                    <div class="controls">
                        <?php if($this->action->id == 'updateTopic'):?>
                            ...
                            <img id="img_url" style="height: 60px; width: auto; margin-left: 220px;" src="<?php echo TopicDecorate::model()->getImageUrl( $model->id , '260');?>"/>
                            <!--<img style="height: 60px; width: auto;margin-left: 220px;" src="<?php // echo TopicDecorate::model()->getImgUrl($model->id, $model->image.'_small.jpg');?>" />-->
                        <?php else:?>
                            <img id="img_file" style="display: none; height: 60px; width: auto; margin-left: 220px;" />
    ...
    <script>
        $("#TopicDecorate_title").keyup(function(){
