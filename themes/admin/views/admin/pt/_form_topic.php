                ...
                <script>
                    $(function(){
                        ...
                        $("#a_file").click(function(){
                            ...
                            $("#img_url").hide();
                            $('#img_file').show();
                            $('#TopicPt_upload_method').val('file');
                        });
                        ...
                        $("#TopicPt_image_url").bind('change keyup blur', function(evt){
                            var method = $('#TopicPt_upload_method').val();
                ...
                <div class="par control-group">
                    ...
                    <div class="controls">
                        <?php if($this->action->id == 'updateTopic'):?>
                            ...
                            <img id="img_url" style="height: 60px; width: auto; margin-left: 220px;" src="<?php echo TopicPt::model()->getImageUrl( $model->id , '260');?>"/>
                            <!--<img style="height: 60px; width: auto;margin-left: 220px;" src="<?php // echo TopicPt::model()->getImgUrl($model->id, $model->image.'_small.jpg');?>" />-->
                        <?php else:?>
                            <img id="img_file" style="display: none; height: 60px; width: auto; margin-left: 220px;" />
