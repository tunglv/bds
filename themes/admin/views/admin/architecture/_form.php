        ...
        <div id="da-ex-tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
            ...
            <div style="padding-bottom: 20px;">
                ...
                <div class="par control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->textField($model,'title',array('maxlength'=>500, 'class' => 'input-large')); ?>
                        <?php echo $form->error($model,'title', array('class' => 'help-inline error'));?>
                    </div>
                    <small class="desc">Name should be 500 chars <span id="name_char_count"></span></small>
                </div>
                ...
                <div class="par control-group">
                    <?php echo $form->labelEx($model,'topic_id', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php echo $form->dropDownList($model,'topic_id', TopicArchitecture::model()->getData()); ?>
                ...
                <script>
                    $(function(){
                        $("#a_url").click(function(){
                            ...
                            $("#img_url").show();
                            $('#img_file').hide();
                            $('#Architecture_upload_method').val('url');    
                        });
                        $("#a_file").click(function(){
                            ...
                            $("#img_url").hide();
                            $('#img_file').show();
                            $('#Architecture_upload_method').val('file');    
                        });
                        ...
                        $("#Architecture_image_url").bind('change keyup blur', function(evt){
                            var method = $('#Architecture_upload_method').val();
                ...
                <div class="par control-group">
                    ...
                    <div class="controls">
                        <?php if($this->action->id == 'update'):?>
                            ...
                            <img id="img_url" style="height: 60px; width: auto; margin-left: 220px;" src="<?php echo Architecture::model()->getImageUrl( $model->id , '260');?>"/>
                            <!--<img style="height: 60px; width: auto;margin-left: 220px;" src="<?php // echo Architecture::model()->getImgUrl($model->id, $model->image.'_small.jpg');?>" />-->
                            <?php else:?> 
                            <img id="img_file" style="display: none; height: 60px; width: auto; margin-left: 220px;" /> 
...
<script>
    $("#Architecture_title").keyup(function(){
