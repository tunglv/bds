...
class DecorateController extends AdminController {
    ...
    public function init() {
        parent::init();
        $this->layout = '//admin/decorate/_layout';
        $this->menu_parent_selected = 'decorate';
    }
    ...
    public function actionIndex() {
        $this->menu_child_selected = 'decorate';
...
//        );
        ...
        if ($productFilter = Yii::app()->request->getQuery('Decorate')) {
    ...
    public function actionIndexTopic(){
        $this->menu_child_selected = 'decorateTopic';
        $this->menu_sub_selected = 'decorateTopic';

        $model = new TopicDecorate();
        $model->unsetAttributes();  // clear any default values
...
//        );
        ...
        if ($productFilter = Yii::app()->request->getQuery('TopicDecorate')) {
            $model->attributes = $productFilter;
            if (isset($productFilter['title']) && $productFilter['title'])
                $criteria->compare('t.title', $productFilter['title']);
        }
    ...
    public function actionCreate() {
        $this->menu_child_selected = 'decorate_create';
        ...
        if (isset($_POST['Decorate'])) {
            $post = Yii::app()->request->getPost('Decorate');
...
//            var_dump($model->getErrors());die;
    ...
    public function actionCreateTopic(){
        $this->menu_child_selected = 'decorateTopic_create';
        $this->menu_sub_selected = 'decorateTopic';

        $model = new TopicDecorate();
        $imgConf = Yii::app()->params->topic_decorate;
        if (isset($_POST['TopicDecorate'])) {
            $post = Yii::app()->request->getPost('TopicDecorate');
            $model->attributes = $post;
            $model->created = time();
            Yii::import('ext.TextParser');
            $model->alias = $model->alias ? $model->alias : $model->title;
...
//            var_dump($model->getErrors());die;
    ...
    public function actionUpdate($id) {
        $this->menu_child_selected = 'decorate_update';
        $this->menu_sub_selected = 'update';

        $model = Decorate::model()->findByPk($id);
    ...
    public function actionUpdateTopic($id){
        $this->menu_child_selected = 'decorateTopic_update';
        $this->menu_sub_selected = 'updateTopic';

        $model = TopicDecorate::model()->findByPk($id);
        $imgConf = Yii::app()->params->topic_decorate;
        if (isset($_POST['TopicDecorate'])) {
            $post = Yii::app()->request->getPost('TopicDecorate');
            //             echo "<pre>";print_r($post);echo "</pre>";die;
    ...
    public function actionDeleteTopic($id){
        $product = TopicDecorate::model()->findByPk($id);
        $product->delete();
    ...
    public function actionDelete($id) {
        $product = Decorate::model()->findByPk($id);
        $product->delete();
