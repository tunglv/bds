...
/**
 * This is the model class for table "topic_decorate".
 *
 * The followings are the available columns in table 'topic_decorate':
 * @property string $id
 * @property string $title
 * @property integer $created
 */
class TopicDecorate extends CActiveRecord
{
	 ...
	 * @return TopicDecorate the static model class
	 */
    ...
    public function getUrl($id = 0, $alias = null){
        ...
        return Yii::app()->createUrl('/web/decorate/topic', array('alias'=>$alias,'id' => $id));
    }
}