...
/**
 * This is the model class for table "topic_architecture".
 *
 * The followings are the available columns in table 'topic_architecture':
 * @property string $id
 * @property string $title
 * @property integer $created
 */
class TopicArchitecture extends CActiveRecord
{
	 ...
	 * @return TopicArchitecture the static model class
	 */
    ...
    public function getUrl($id = 0, $alias = null){
        ...
        return Yii::app()->createUrl('/web/architecture/topic', array('alias'=>$alias,'id' => $id));
    }
}