...
/**
 * This is the model class for table "images_sale".
 *
 * The followings are the available columns in table 'images_sale':
 * @property string $id
 * @property string $image
 * @property integer $bds_sale_id
 * @property integer $is_cover
 */
class ImagesSale extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ImagesSale the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('image, bds_sale_id', 'required'),
			array('bds_sale_id, is_cover', 'numerical', 'integerOnly'=>true),
			array('image', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, image, bds_sale_id, is_cover', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('bds_sale_id',$this->bds_sale_id);
