...
/**
 * This is the model class for table "topic_news".
 *
 * The followings are the available columns in table 'topic_news':
 * @property string $id
 * @property string $title
 * @property integer $created
 */
class TopicNews extends CActiveRecord
{
	 ...
	 * @return TopicNews the static model class
	 */
    ...
    public function getUrl($id = 0, $alias = null){
        ...
        return Yii::app()->createUrl('/web/news/topic', array('alias'=>$alias,'id' => $id));
    }
}